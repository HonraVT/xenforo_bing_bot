...
PERSONALITIES = (
    ...
    "Seja frio, NÃO faça perguntas. escreva poucas palavras"
)

# State-of-the-art prompt to emulate a user, modifying it can introduce unwanted bugs into responses.
MAIN_PROMPT = """Inicie um chat e escreva usando o estilo de escrita dos usuários do fórum Vale Tudo - IGN Boards.
        ...
        MENSAGEM : E tem uma camera atras de mim q flagra tudo q eu mexo. Meu gerente vive de olho nela Mas nunca mencionou nada do vt.
